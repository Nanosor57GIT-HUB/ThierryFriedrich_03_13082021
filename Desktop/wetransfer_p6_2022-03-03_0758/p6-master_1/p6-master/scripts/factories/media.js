class VideoMediaSubFactory {
  static render(video, likes, w, h, title) {
    return `
    <video controls  preload="metadata" class="media-card-img lb-target">
    ...
    article.innerHTML = `
      ...
      ${
        image
          ...
          : VideoMediaSubFactory.render(video, "300", "300", name, title, likes)
      }
    ...
    article.innerHTML = `
      ...
      ${
        image
          ...
          : VideoMediaSubFactory.render(video, "400", "300", name, title)
      } 
